...
app.post("/login", function (req, res) {
  ...
  if (user && user.password === password) {
    ...
    // Also send back a test token
    const token = "eyasgjadlljl;3lkq5l1kldkhjwlej3;skhmkhyljekt3o5jkfhnlyo[pt";
...
app.post('/problems', isAdmin, (req, res) => {
  ...
  return res.status(200).json({ message: 'New problem has been added successfully' });
});
