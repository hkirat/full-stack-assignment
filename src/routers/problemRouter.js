...
const { isProblemCreator } = require("../../middleware/isProblemCreator");
...
router
  ...
  .post(
    ...
    isAdmin,
    validateProblem,
    catchAsync(problemController.addProblem)
  );
...
router
  ...
  .put(
    ...
    isAdmin,
    isProblemCreator,
    catchAsync(problemController.editProblem)
  )
  .delete(
    isAuth,
    isAdmin,
    isProblemCreator,
    catchAsync(problemController.deleteProblem)
  );
